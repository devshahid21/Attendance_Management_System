                ...
                <div class="content">
                    <div class="container-fluid">
                        <div id="bodywrapper" class="container-fluid showhidetoggle">
                            ...
                            <br>
                            <h1>Admin Message Form</h1>
                            <form action="process/notification.php" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="action" value="notification">
                                <div class="form-group">
                                    <label class="col-sm-3 col-form-label">Names:</label>
                                    <select name="name[]" class="form-control" required id="userSelect" multiple>
                                ...
                                <div class="form-container">
                                    <br><input type="submit" value="Submit Message" class="btn btn-primary">
                                </div>
                            </form>
